...
public class MajorHeartbeatMessage implements Event{
	private int type;
	...
	public byte[] majorHeartbeatMessage(String IP, int port, String info) throws IOException
	{
		type = Protocol.MAJOR_HEARTBEAT_MESSAGE;
		Date dte=new Date();
