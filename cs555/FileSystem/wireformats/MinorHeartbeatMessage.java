...
public class MinorHeartbeatMessage implements Event{
	private int type;
	...
	public byte[] minorHeartbeatMessage(String IP, int port, String info) throws IOException
	{
		type = Protocol.MINOR_HEARTBEAT_MESSAGE;
		Date dte=new Date();
