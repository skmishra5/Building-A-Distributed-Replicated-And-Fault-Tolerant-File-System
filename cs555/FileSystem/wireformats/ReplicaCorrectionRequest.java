...
public class ReplicaCorrectionRequest implements Event{
	private int type;
	...
	public byte[] replicaCorrectionRequest(String IP, int listenPort, String inf) throws IOException
	{
		type = Protocol.REPLICA_CORRECTION_REQUEST;
		Date dte=new Date();
