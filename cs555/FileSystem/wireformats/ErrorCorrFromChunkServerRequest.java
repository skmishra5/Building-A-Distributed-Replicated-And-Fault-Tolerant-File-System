...
public class ErrorCorrFromChunkServerRequest implements Event{
	private int type;
	...
	public byte[] errorCorrFromChunkServerRequest(String IP, int listenPort, String flName) throws IOException
	{
		type = Protocol.ERROR_CORRECTION_FROM_CHUNKSERVER_REQUEST;
		Date dte=new Date();
