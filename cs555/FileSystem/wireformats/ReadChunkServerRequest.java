...
public class ReadChunkServerRequest implements Event{
	private int type;
	...
	public byte[] readFileChunkServerRequest(String IP, int listenPort, String flName) throws IOException
	{
		type = Protocol.READ_FILE_CHUNK_SERVER_REQUEST;
		Date dte=new Date();
