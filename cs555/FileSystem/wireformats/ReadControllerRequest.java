...
public class ReadControllerRequest implements Event{
	private int type;
	...
	public int getForwardFlag(){ return numSplits; }
	public int getFingerTableEntry(){ return -1; }
	
	public byte[] readFileControllerRequest(String IP, int listenPort, String flName, int nSplits) throws IOException
	{
		type = Protocol.READ_FILE_CONTROLLER_REQUEST;
		Date dte=new Date();
