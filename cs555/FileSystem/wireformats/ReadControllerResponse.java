...
public class ReadControllerResponse implements Event{
	private int type;
	...
	public byte[] readFileControllerResponse(String inf) throws IOException
	{
		type = Protocol.READ_FILE_CONTROLLER_RESPONSE;
		Date dte=new Date();
