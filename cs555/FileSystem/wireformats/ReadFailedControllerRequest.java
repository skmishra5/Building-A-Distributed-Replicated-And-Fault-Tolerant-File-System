...
public class ReadFailedControllerRequest implements Event{
	private int type;
	...
	public byte[] readFailedControllerRequest(String IP, int listenPort, String inf) throws IOException
	{
		type = Protocol.READ_FAILED_CONTROLLER_REQUEST;
		Date dte=new Date();
