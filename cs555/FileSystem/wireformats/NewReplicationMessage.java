...
public class NewReplicationMessage implements Event{
	private int type;
	...
	public byte[] newReplicationMessage(String inf) throws IOException
	{
		type = Protocol.NEW_REPLICATION_MESSAGE;
		Date dte=new Date();
